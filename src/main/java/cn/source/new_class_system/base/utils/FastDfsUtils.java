...
public class FastDfsUtils {
     ...
     * @return
     */
    public static Map<String,String> uploadFile(InputStream inputStream, String fileName) {
        try {
            // 文件的元数据
            ...
            param.put("groupName",fileids[0]);
            param.put("fileUrl",fileids[1]);
     ...
     * @return 返回一个流
     */
    public static byte[] downloadFileByte(String groupName, String remoteFileName) {
        try {
            byte[] bytes = storageClient.download_file(groupName, remoteFileName);
